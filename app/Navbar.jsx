...
export default function Navbar({ preloadedSettings = null }) {
  ...
  return (
    <nav id="main-navbar" className="sticky top-0 z-[9999] flex items-center px-4 py-4 md:px-[2vw] md:py-[1.2vw] lg:px-[2.5vw] lg:py-[1.5vw] xl:px-[1.8vw] xl:py-[.4vw] bg-black text-white font-['Share_Tech']">
      ...
      >
        <Link href="/menu" className="whitespace-nowrap">MENU</Link>
        ...
        <Link href="/the-journey" className="whitespace-nowrap">THE JOURNEY</Link>
        <Link href="/careers" className="whitespace-nowrap">CAREERS</Link>
      </div>
      ...
      >
        <a
          ...
          className="border-[0.15vw] border-white md:px-[1.5vw] lg:px-[2vw] xl:px-[2.3vw] md:py-[.6vw] lg:py-[.8vw] xl:py-[.5vw] md:rounded-[0.9vw] lg:rounded-[1.2vw] xl:rounded-[0.95vw] md:text-[1vw] lg:text-[1.2vw] xl:text-[1vw] transition-all duration-300 hover:shadow-[0.4vw_0.4vw_0px_white] whitespace-nowrap"
        >
          CLICK & COLLECT
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 border-[0.15vw] border-white md:px-[1.5vw] lg:px-[2vw] xl:px-[2.3vw] md:py-[.6vw] lg:py-[.8vw] xl:py-[.5vw] md:rounded-[0.9vw] lg:rounded-[1.2vw] xl:rounded-[0.95vw] md:text-[1vw] lg:text-[1.2vw] xl:text-[1vw] transition-all duration-300 hover:shadow-[0.4vw_0.4vw_0px_white] whitespace-nowrap"
        >
