  ...
  return (
    <nav id="main-navbar" className="sticky top-0 z-[9999] flex items-center px-4 py-4 md:px-[2vw] md:py-[1.2vw] lg:px-[2.5vw] lg:py-[1.5vw] xl:px-[1.8vw] xl:py-[.4vw] bg-black text-white font-['Share_Tech']">
      ...
      >
        ...
        <Link href="/careers" className="whitespace-nowrap mr-[1vw] lg:mr-[1.2vw] xl:mr-[1.5vw]">CAREERS</Link>
      </div>
      ...
      >
        <a
          ...
          className="border-[0.15vw] border-white md:px-[1.8vw] lg:px-[2.2vw] xl:px-[2.5vw] md:py-[.6vw] lg:py-[.8vw] xl:py-[.5vw] rounded-full md:text-[1vw] lg:text-[1.2vw] xl:text-[1vw] transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.25)] whitespace-nowrap"
        >
          CLICK & COLLECT
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 border-[0.15vw] border-white md:px-[1.8vw] lg:px-[2.2vw] xl:px-[2.5vw] md:py-[.6vw] lg:py-[.8vw] xl:py-[.5vw] rounded-full md:text-[1vw] lg:text-[1.2vw] xl:text-[1vw] transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.25)] whitespace-nowrap"
        >
