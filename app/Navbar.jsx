    ...
    <nav id="main-navbar" className="sticky top-0 z-[9999] flex items-center px-4 py-4 md:px-[2vw] md:py-[1.2vw] lg:px-[2.5vw] lg:py-[1.5vw] xl:px-[1.8vw] xl:py-[.4vw] bg-black text-white font-['Share_Tech']">
      ...
      >
        <a
          ...
          className="navbar-action-button border-[0.15vw] md:px-[1.8vw] lg:px-[2.2vw] xl:px-[2.5vw] md:py-[.6vw] lg:py-[.8vw] xl:py-[.5vw] rounded-full md:text-[1vw] lg:text-[1.2vw] xl:text-[1vw] whitespace-nowrap"
        >
          CLICK & COLLECT
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="navbar-action-button flex items-center gap-2 border-[0.15vw] md:px-[1.8vw] lg:px-[2.2vw] xl:px-[2.5vw] md:py-[.6vw] lg:py-[.8vw] xl:py-[.5vw] rounded-full md:text-[1vw] lg:text-[1.2vw] xl:text-[1vw] whitespace-nowrap"
        >
