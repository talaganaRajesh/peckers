                        ...
                        >
                            <div className="relative w-full h-full flex flex-col items-center bg-black">
                                ...
                                >
                                    ...
                                    {/* DESCRIPTION */}
                                    <div className="text-[13px] sm:text-[14px] md:text-[13px] lg:text-[14px] xl:text-[0.9vw] leading-[1.5em] font-bold font-['Inconsolata'] tracking-wider space-y-1">
                                        <p>
                                            {sauce.descLine1}<br />
                                            {sauce.descLine2}
                                        </p>
                                    ...
                                    <div className="flex flex-col items-center mt-3 md:mt-2 xl:mt-[0.8vw]">
                                        <div className="mb-2">
                                            <div className="px-3 sm:px-4 md:px-[1vw] py-1 md:py-[0.35vw] rounded-[100px] border border-white/20 flex items-center justify-center gap-1.5 sm:gap-2 md:gap-[0.5vw] bg-black/30 backdrop-blur-md">
                                                <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[8px] h-[10px] sm:w-[10px] sm:h-[12px] md:w-[0.85vw] md:h-[1vw]">
                                                ...
                                                <span style={{ fontFamily: 'var(--font-peakers)' }} className="text-[12px] sm:text-[13px] md:text-[0.9vw] xl:text-[0.8vw] font-bold tracking-[0.07em] uppercase translate-y-px">
                                                    FRESHLY MADE IN-HOUSE EVERY DAY | NO ADDED PRESERVATIVES UNLIKE BIG BOYS
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        {sauce.cal && sauce.cal !== "-" && (
                                            <div className="flex flex-row flex-wrap justify-center items-center gap-2 font-bold">
                                                <div className="px-2 sm:px-3 md:px-[0.8vw] py-1 md:py-[0.3vw] rounded-[100px] bg-white/5 border border-white/10 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-[0.4vw] backdrop-blur-md">
                                                    <span className="text-[9px] sm:text-[10px] md:text-[0.65vw] text-white/40 font-mono">CAL</span>
                                                    <span className="text-[12px] sm:text-[13px] md:text-[1vw] xl:text-[0.85vw]">{sauce.cal}</span>
                                                </div>
                                                <div className="px-2 sm:px-3 md:px-[0.8vw] py-1 md:py-[0.3vw] rounded-[100px] bg-white/5 border border-white/10 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-[0.4vw] backdrop-blur-md">
                                                    <span className="text-[9px] sm:text-[10px] md:text-[0.65vw] text-white/40 font-mono">P(g)</span>
                                                    <span className="text-[12px] sm:text-[13px] md:text-[1vw] xl:text-[0.85vw]">{sauce.protein}</span>
                                                </div>
                                                <div className="px-2 sm:px-3 md:px-[0.8vw] py-1 md:py-[0.3vw] rounded-[100px] bg-white/5 border border-white/10 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-[0.4vw] backdrop-blur-md">
                                                    <span className="text-[9px] sm:text-[10px] md:text-[0.65vw] text-white/40 font-mono">C(g)</span>
                                                    <span className="text-[12px] sm:text-[13px] md:text-[1vw] xl:text-[0.85vw]">{sauce.carbs}</span>
                                                </div>
                                                <div className="px-2 sm:px-3 md:px-[0.8vw] py-1 md:py-[0.3vw] rounded-[100px] bg-white/5 border border-white/10 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-[0.4vw] backdrop-blur-md">
                                                    <span className="text-[9px] sm:text-[10px] md:text-[0.65vw] text-white/40 font-mono">F(g)</span>
                                                    <span className="text-[12px] sm:text-[13px] md:text-[1vw] xl:text-[0.85vw]">{sauce.fat}</span>
                                                </div>
                                            </div>
                                        )}
                                    </div>
