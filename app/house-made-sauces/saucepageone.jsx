                        ...
                        >
                            <div className="relative w-full h-full flex flex-col items-center bg-black">
                                ...
                                >
                                    ...
                                    {/* DESCRIPTION */}
                                    <div className="text-[13px] sm:text-[14px] md:text-[13px] lg:text-[14px] xl:text-[0.9vw] leading-[1.5em] font-light font-['Inconsolata'] tracking-wider space-y-1">
                                        <p>
                                            {sauce.descLine1}<br />
                                            {sauce.descLine2}
                                        </p>
                                    ...
                                    <div className="flex flex-col items-center mt-3 md:mt-2 xl:mt-[0.8vw]">
                                        <div className="mb-2">
                                            <div className="px-3 sm:px-4 md:px-[1vw] py-1 md:py-[0.35vw] rounded-[100px] border border-white/20 flex items-center justify-center gap-1.5 sm:gap-2 md:gap-[0.5vw] bg-black/30 backdrop-blur-md">
                                                ...
                                                <span style={{ fontFamily: 'var(--font-peakers)' }} className="text-[12px] sm:text-[13px] md:text-[0.9vw] xl:text-[0.8vw] font-normal tracking-[0.07em] uppercase translate-y-px">
