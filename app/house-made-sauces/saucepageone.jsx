                        ...
                        >
                            <div className="relative w-full h-full flex flex-col items-center bg-black">
                                ...
                                >
                                    ...
                                    <div className="text-[13px] sm:text-[14px] md:text-[13px] lg:text-[14px] xl:text-[0.9vw] leading-[1.4em] md:leading-[1.5em] xl:leading-[1.2vw] py-[0.5vw] font-light md:font-normal lg:font-normal xl:font-light font-['Inconsolata'] tracking-wider space-y-1 md:space-y-1 lg:space-y-1 xl:space-y-[0.3vw]">
                                        <p>
                                            {sauce.descLine1}<br />
                                            {sauce.descLine2}
                                        </p>
                                        ...
                                        <div className="flex flex-col items-center">
                                            <div className="mb-1.5 md:mb-[0.3vw]">
                                                <div className="px-3 sm:px-4 md:px-[1vw] py-1 md:py-[0.3vw] rounded-[100px] border border-white/20 flex items-center justify-center gap-1.5 sm:gap-2 md:gap-[0.6vw] bg-black/30 backdrop-blur-md">
                                                    ...
                                                    <span style={{ fontFamily: 'var(--font-peakers)' }} className="text-[13px] sm:text-[14px] md:text-[1.1vw] xl:text-[0.9vw] font-normal tracking-[0.05em] uppercase translate-y-px">
                                                        {sauce.cal && sauce.cal !== "-" ? "FRESHLY MADE IN-HOUSE EVERY DAY" : "NO PRESERVATIVES"}
                                                    </span>
                                                </div>
                                            </div>

                                            <div className="flex mt-2 flex-row flex-wrap justify-center items-center gap-2 md:gap-2 font-bold">
                                                {sauce.cal && sauce.cal !== "-" && (
                                                    <div className="flex flex-row flex-wrap justify-center gap-2">
                                                        <div className="px-2 sm:px-3 md:px-[0.8vw] py-1 md:py-[0.3vw] rounded-[100px] bg-white/5 border border-white/10 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-[0.5vw] backdrop-blur-md">
                                                            <span className="text-[9px] sm:text-[10px] md:text-[0.7vw] text-white/40 font-mono">CAL</span>
                                                            <span className="text-[12px] sm:text-[14px] md:text-[1.1vw] xl:text-[0.9vw]">{sauce.cal}</span>
                                                        </div>
                                                        <div className="px-2 sm:px-3 md:px-[0.8vw] py-1 md:py-[0.3vw] rounded-[100px] bg-white/5 border border-white/10 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-[0.5vw] backdrop-blur-md">
                                                            <span className="text-[9px] sm:text-[10px] md:text-[0.7vw] text-white/40 font-mono">P(g)</span>
                                                            <span className="text-[12px] sm:text-[14px] md:text-[1.1vw] xl:text-[0.9vw]">{sauce.protein}</span>
                                                        </div>
                                                        <div className="px-2 sm:px-3 md:px-[0.8vw] py-1 md:py-[0.3vw] rounded-[100px] bg-white/5 border border-white/10 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-[0.5vw] backdrop-blur-md">
                                                            <span className="text-[9px] sm:text-[10px] md:text-[0.7vw] text-white/40 font-mono">C(g)</span>
                                                            <span className="text-[12px] sm:text-[14px] md:text-[1.1vw] xl:text-[0.9vw]">{sauce.carbs}</span>
                                                        </div>
                                                        <div className="px-2 sm:px-3 md:px-[0.8vw] py-1 md:py-[0.3vw] rounded-[100px] bg-white/5 border border-white/10 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-[0.5vw] backdrop-blur-md">
                                                            <span className="text-[9px] sm:text-[10px] md:text-[0.7vw] text-white/40 font-mono">F(g)</span>
                                                            <span className="text-[12px] sm:text-[14px] md:text-[1.1vw] xl:text-[0.9vw]">{sauce.fat}</span>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
