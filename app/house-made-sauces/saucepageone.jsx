...
export default function SaucePageOne({ initialData = [] }) {
    ...
    return (
        <div className="relative w-full overflow-hidden bg-black flex flex-col items-center">
            ...
            <div className="relative w-full min-h-screen sm:min-h-[120vw] md:min-h-[60vw] lg:min-h-[55vw] xl:min-h-[50vw]">
                    ...
                    return (
                        ...
                        >
                            <div className="relative w-full flex flex-col items-center pb-[25vw] min-h-[175vw] sm:min-h-[120vw] md:min-h-[60vw] lg:min-h-[55vw] xl:min-h-[50vw] sm:pb-[100vw] md:pb-[20vw] lg:pb-[26vw] xl:pb-[26vw] bg-black">
                                ...
                                >
                                    <h1
                                        className="text-3xl sm:text-4xl md:text-[40px] lg:text-[48px] xl:text-[4vw] font-bold tracking-wide mb-1 sm:mb-2 md:mb-3 xl:mb-[-0.2vw]"
                                        style={{ fontFamily: 'var(--font-peakers)' }}
                                    >
                                        {sauce.title}
                                    </h1>

                                    <div className="text-[13px] sm:text-[14px] md:text-[11px] lg:text-[12px] xl:text-[1vw] leading-[1.4em] md:leading-[1.5em] xl:leading-[1.2vw] py-[1vw] font-light md:font-normal lg:font-normal xl:font-light font-['Inconsolata'] tracking-wider space-y-1 md:space-y-1.5 lg:space-y-2 xl:space-y-[0.4vw]">
                                        <p>
                                            {sauce.descLine1}<br />
                                            {sauce.descLine2}
                                        </p>
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            <div className="mb-1.5 md:mb-[0.6vw]">
                                                <div className="px-3 sm:px-4 md:px-[1.5vw] py-1 md:py-[0.5vw] rounded-[100px] border border-white/20 flex items-center justify-center gap-1.5 sm:gap-2 md:gap-[0.6vw] bg-black/30 backdrop-blur-md">
                                                    ...
                                                    <span style={{ fontFamily: 'var(--font-peakers)' }} className="text-[11px] sm:text-[13px] md:text-[1.4vw] xl:text-[0.8vw] font-normal tracking-[0.05em] uppercase translate-y-px">
