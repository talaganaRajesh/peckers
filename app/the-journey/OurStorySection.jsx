    ...
    <section className="relative w-full lg:min-h-[80vh] bg-black px-[1.5vw] pt-[1vh] lg:pt-[5vh] pb-[9vh] lg:pb-0 mb-0 text-white flex flex-col justify-start items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col lg:flex-row items-start lg:items-center justify-center pt-0">
        <div className="w-full flex flex-col-reverse lg:flex-row items-center lg:items-start justify-start lg:justify-center gap-y-6 lg:gap-y-0 lg:gap-x-2">
          <div className="relative w-full lg:w-1/2 px-[5vw] lg:px-[5vw] flex flex-col justify-start mt-[4vw] lg:mt-0 overflow-hidden text-left h-[50vh] md:h-[48vh] lg:h-[67vh] xl:h-[72vh]">
            <div className="h-full min-h-0 flex flex-col">
              <h2 className="font-bold font-peakers text-[7.2vw] md:text-[5.2vw] lg:text-[52px] xl:text-[60px] leading-[1.05] lg:leading-[1.1] uppercase mt-2 lg:mt-0 text-white">
                {fixedHeading}
              </h2>
              ...
              <AnimatePresence mode="wait" custom={direction}>
                <motion.div
                  ...
                  data-lenis-prevent
                  className="custom-scrollbar text-[#D1D5DB] font-neuzeit text-[4.5vw] md:text-[22px] lg:text-[18px] xl:text-[1.15vw] leading-[1.6] max-w-full lg:max-w-[40vw] pt-[3vw] md:pt-[20px] lg:pt-[3vw] pb-2 flex-1 min-h-0 overflow-y-scroll overscroll-contain pr-2"
                >
                  {(() => {
                    const bodyArray =
              ...
              <div className="flex items-center justify-start gap-1 lg:gap-2 mt-4 lg:mt-6 pb-0 lg:pb-1 shrink-0">
                {slides.map((_, i) => (
                  <div
                    key={i}
              ...
              {fixedSubHeading && (
                <p className="text-zinc-500 font-neuzeit text-[4.2vw] md:text-[18px] lg:text-[16px] xl:text-[1.1vw] leading-[1.45] max-w-full lg:max-w-[42vw] mt-3 lg:mt-6 pb-0 shrink-0">
                  {fixedSubHeading}
                </p>
              )}
            </div>
          ...
          <div className="w-full lg:w-1/2 h-auto px-[4vw] lg:px-[2vw] flex flex-col items-start lg:justify-start justify-center mt-0 lg:mt-0">
            <div className="relative w-full h-[60vw] md:h-[55vw] lg:h-[62vh] overflow-hidden flex items-center lg:items-start justify-start lg:justify-center px-0 lg:px-4">
              <AnimatePresence mode="wait" custom={direction}>
              ...
              {(() => {
                ...
                return (
                  <motion.p
                    ...
                    className="mt-4 lg:mt-8 text-[3.8vw] md:text-[16px] lg:text-[15px] xl:text-[0.95vw] text-white/70 font-neuzeit uppercase tracking-[0.15em] text-center w-full px-0 lg:px-4 leading-relaxed"
                  >
                    {desc}
                  </motion.p>
                );
