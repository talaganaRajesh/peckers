          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-[4vh]">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-[4vh] md:gap-[2vw]">
              <div className="w-full">
                ...
                <input
                  ...
                  required
                  className="w-full font-mono bg-[#000000] border border-gray-700 rounded-[2vw] md:rounded-xl px-[4vw] md:px-[1.2vw] py-[2vh] text-gray-300 outline-none text-[4vw] md:text-base disabled:opacity-50"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                required
                className="w-full font-mono bg-[#000000] border border-gray-700 rounded-[2vw] md:rounded-xl px-[4vw] md:px-[1.2vw] py-[2vh] text-gray-300 outline-none resize-none text-[4vw] md:text-base disabled:opacity-50"
              ></textarea>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-white text-black font-bold py-[2.5vh] text-[4.5vw] md:text-[1.1vw] tracking-wide hover:bg-gray-200 transition uppercase flex items-center justify-center gap-2 disabled:opacity-50 rounded-[2vw] md:rounded-[0.6vw]"
              >
                {isSubmitting ? (
                  <>
              ...
              {error && (
                <p className="text-red-500 font-mono text-[3vw] md:text-[0.8vw] text-center uppercase">
                  {error}
                </p>
              )}
            </div>
