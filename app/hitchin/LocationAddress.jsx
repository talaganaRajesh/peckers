    ...
    <section>
      <div className="flex justify-center items-center md:min-h-0 lg:min-h-0 xl:min-h-[75vh] mt-6">
        ...
        >
          ...
          >
            <div
              className="text-white text-[8vw] md:text-[36px] lg:text-[48px] xl:text-[3.6vw] tracking-[0.1vw] font-bold uppercase mb-2"
