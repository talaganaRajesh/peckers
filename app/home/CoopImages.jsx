            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  className="w-[60%] md:w-[70%] lg:w-[65%] xl:w-[60%] py-[3vw] md:py-[3.5vw] lg:py-[0.8vw] xl:py-[0.2vw] border-2 border-[#383838] rounded-[4vw] md:rounded-[3vw] lg:rounded-[1.5vw] xl:rounded-[1vw] text-white font-mono text-[4vw] md:text-[4vw] lg:text-[1.5vw] xl:text-[1.2vw] tracking-widest transition-all bg-[#1111] hover:shadow-[0.4vw_0.4vw_0px_white] disabled:opacity-50 disabled:hover:shadow-none flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
