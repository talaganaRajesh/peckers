...
export default function RatingSection({ data = null }) {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row items-center justify-between bg-black font-bold tracking-tight px-[5vw] md:px-[6vw] lg:px-[2.5vw] xl:px-[2vw] pt-[10vw] md:pt-[10vw] lg:pt-[8vw] xl:pt-[12.5vw] pb-[6vw] md:pb-[8vw] lg:pb-[3vw] xl:pb-[2vw] gap-[4vw] md:gap-[5vw] lg:gap-0">
      <span
