    ...
    >
      ...
      >
        ...
        <div className="flex justify-center lg:justify-start w-full">
          <a
            href="#"
            className="group inline-flex flex-col items-center lg:items-start text-white gap-[1vw] xl:gap-[.3vw] font-sans text-[3.5vw] sm:text-[2.5vw] md:text-[2.5vw] lg:text-[1.3vw] xl:text-[1.1vw] font-extralight"
            style={{ letterSpacing: "0.08em", width: "fit-content" }}
          >
            <span className="flex items-center gap-[1.5vw] md:gap-[2vw] lg:gap-[1vw] xl:gap-[.4vw]">
              <span className="border-b-2 border-white mt-[2vw] md:mt-[3vw] lg:mt-[1vw] xl:mt-[1vw] pb-[2vw] md:pb-[2.5vw] lg:pb-[8px] xl:pb-[7px] pr-[.5vw] xl:pr-[.1vw] tracking-[0.09em]">
